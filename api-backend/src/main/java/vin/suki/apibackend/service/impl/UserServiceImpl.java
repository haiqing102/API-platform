...
import vin.suki.apibackend.mapper.UserMapper;
...
import vin.suki.apicommon.model.dto.user.UserBindEmailRequest;
import vin.suki.apicommon.model.dto.user.UserEmailLoginRequest;
import vin.suki.apicommon.model.dto.user.UserEmailRegisterRequest;
import vin.suki.apicommon.model.dto.user.UserRegisterRequest;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements UserService {
	...
	public long userEmailRegister(UserEmailRegisterRequest userEmailRegisterRequest) {
		...
		String cacheCaptcha = redisTemplate.opsForValue().get(EmailConstant.CAPTCHA_CACHE_KEY + email);
