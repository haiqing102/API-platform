...
import edu.cqupt.apibackend.common.config.AliPayConfig;
import edu.cqupt.apibackend.common.config.EmailConfig;
import edu.cqupt.apibackend.common.util.EmailUtil;
import edu.cqupt.apibackend.mapper.ProductOrderMapper;
import edu.cqupt.apibackend.service.PaymentInfoService;
...
import edu.cqupt.apicommon.common.enums.AlipayTradeStatusEnum;
...
import edu.cqupt.apicommon.model.dto.pay.AliPayAsyncResponse;
...
import static edu.cqupt.apibackend.common.constant.PayConstant.*;
import static edu.cqupt.apicommon.common.enums.PayTypeStatusEnum.ALIPAY;
import static edu.cqupt.apicommon.common.enums.PaymentStatusEnum.*;
...
public class AlipayOrderServiceImpl extends ServiceImpl<ProductOrderMapper, ProductOrder> implements ProductOrderService {
	...
	public ProductOrderVo getProductOrder(Long productId, UserVo loginUser, String payType) {
		...
		lambdaQueryWrapper.eq(ProductOrder::getStatus, PaymentStatusEnum.NOT_PAY.getValue());
	...
	public ProductOrderVo saveProductOrder(Long productId, UserVo loginUser) {
		...
		productOrder.setStatus(PaymentStatusEnum.NOT_PAY.getValue());
	...
	public void processingTimedOutOrders(ProductOrder productOrder) {
		...
		try {
			...
			if (tradeStatus.equals(NOT_PAY.getValue()) || tradeStatus.equals(CLOSED.getValue())) {
