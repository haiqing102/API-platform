...
import static edu.cqupt.apibackend.common.constant.PayConstant.ORDER_PREFIX;
import static edu.cqupt.apibackend.common.constant.PayConstant.QUERY_ORDER_STATUS;
import static edu.cqupt.apibackend.common.util.WxPayUtil.getRequestHeader;
...
public class WxOrderServiceImpl extends ServiceImpl<ProductOrderMapper, ProductOrder> implements ProductOrderService {
    ...
    public void processingTimedOutOrders(ProductOrder productOrder) {
        ...
        try {
            ...
            if (tradeState.equals(NOT_PAY.getValue()) || tradeState.equals(CLOSED.getValue())) {
    ...
    public String doPaymentNotify(String notifyData, HttpServletRequest request) {
        ...
        try {
            ...
            throw new BusinessException(ResponseCode.OPERATION_ERROR, "支付失败");
        } catch (Exception e) {
